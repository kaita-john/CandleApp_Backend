...
class Request(ParentModel):
    ...
    cancelled_by = models.ForeignKey( AppUser, on_delete=models.CASCADE, blank=True, null=True, related_name='cancellencations_as_user')
    ...
    def save(self, *args, **kwargs):
        ...
        if self.complete_requested_by_celeb == True:
            self.state = "COMPLETED"

        if self.shoutout_video and self.shoutout_video != "":
